...
const ICONS: Record<string, string[]> = {
  ...
  users: ['M9 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8z', 'M2 21a7 7 0 0 1 14 0', 'M17 11a4 4 0 0 0 0-8', 'M22 21a7 7 0 0 0-5-6.7'],
  ...
  cog: ['M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6z', 'M12 2v3', 'M12 19v3', 'M2 12h3', 'M19 12h3', 'M5 5l2 2', 'M17 17l2 2', 'M19 5l-2 2', 'M7 17l-2 2'],
  ...
  eyeoff: ['M3 3l18 18', 'M10.5 5.2A9.7 9.7 0 0 1 12 5c6.5 0 10 7 10 7a17 17 0 0 1-3.3 4', 'M6.2 6.3C3.4 8.1 2 12 2 12s3.5 7 10 7a9.7 9.7 0 0 0 4-.9'],
