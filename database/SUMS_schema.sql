...
-- SUMS PostgreSQL 17 schema-only export.
-- Safe for source control: contains no users, password hashes, tokens, sessions, or runtime records.
-- After loading this schema, run the Prisma development seed to create fictional demo data.
